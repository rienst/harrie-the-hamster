...
/**
 * This is where Harrie checks the variables above, as well as the environment
 * variables from your environment, and puts them in contants which he can use
 * for the cool stuff he does. Remember that he chooses your environment
...
harrie.on('voiceStateUpdate', (oldMember, newMember) => {
  ...
  /**
   * Finally, if someone joined or left, Harrie will send out the notification
   * he made to the notification channel.
   */
  if (oldChannel === null || newChannel === null) {
